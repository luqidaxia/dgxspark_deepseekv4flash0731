#!/bin/bash
# ============================================================
# DeepSeek V4 Flash — TP=2 分两组 — 组A: node01 (head, rank 0)
# 组A = node01 + node02 (TP=2, nnodes=2)
# 启动顺序: 先启动 node02 (worker)，再启动本 head 脚本
# ============================================================
set -euo pipefail
...
NODE_RANK=0
VLLM_HOST_IP="$GROUP_A_MASTER_ADDR"
...
echo "========================================"
echo " DeepSeek V4 Flash - 组A node01 (head, rank 0, TP=2)"
echo "========================================"
...
# --- 启动 head 容器 ---
echo "🚀 启动 组A node01 (head, rank 0, TP=2)..."
...
echo ""
echo "✅ 组A node01 (head, rank 0, TP=2) 已启动 (容器 vllm_anemll)"
